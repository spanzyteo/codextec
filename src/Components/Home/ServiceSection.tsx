...
const ServiceSection = () => {
  return (
    <div className="flex flex-col py-[90px] mx-auto px-5 md:px-20 bg-cover bg-center bg-no-repeat bg-[url(/wallpaper.jpg)]">
            ...
            <div key={item.id} className="flex">
              <div className="bg-white p-4 gap-4 shadow-md w-full flex flex-col h-full">
                <Link
                  ...
                  className="flex flex-col p-6 gap-8 hover:bg-[#0F4BB9] group cursor-pointer transition-all duration-500 ease-in-out h-full"
                >
