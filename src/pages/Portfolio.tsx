...
const Portfolio = () => {
  return (
    <>
      <Helmet>
      <title>Our Portfolio | Codextec - Showcasing Our Projects</title>
      <meta
          name="description"
          content="Explore Codextec's portfolio showcasing innovative web and software development projects that drive success for businesses in Nigeria."
        />
        <meta
          name="keywords"
          content="portfolio, web development Nigeria, software solutions, mobile app development, digital marketing Nigeria, Codextec portfolio"
        />
        <meta name="author" content="Codextec" />
        <meta property="og:title" content="Our Portfolio | Codextec - Web & Software Development in Nigeria" />
        <meta
          property="og:description"
          content="Explore Codextec's portfolio showcasing innovative web and software development projects that drive success for businesses in Nigeria."
        />
        <meta property="og:url" content="https://codextec.vercel.app/portfolio" />
